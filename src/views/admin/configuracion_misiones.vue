  ...
  data () {
    ...
    methods: {
        ...
        getAeronaves(){
            let me = this
            me.$vs.loading()
            axios.get('http://127.0.0.1:8000/api/aeronaves')
            .then(function (res) {
        ...
        eliminarEvento(){
          let me = this
            axios.delete('http://127.0.0.1:8000/api/eventos/'+ me.id_evento)
            .then(function (res) {
                me.getEventos()
            })
            .catch(function (error) {})
        ...
        eliminarAeronave(){
          let me = this
            axios.delete('http://127.0.0.1:8000/api/aeronaves/'+ me.id_aeronave)
            .then(function (res) {
                me.getAeronaves()
            })
            .catch(function (error) {})
        ...
        crearAeronave(){
            ...
            me.$vs.loading()
            axios.post('http://127.0.0.1:8000/api/aeronaves', formData)
            .then(function (res) {
                me.$vs.loading.close()
                me.nombre_aeronave=''
                me.$vs.notify({
