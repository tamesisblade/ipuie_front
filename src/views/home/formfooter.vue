<template>
<div class="vx-row" style="background-color: #212F3D; color: #F1C40F; font-size: 15px;">
    ...
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base pt-5">
    ...
    <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base p-12" align="center">
        <img style="width: 120px;" :src="'http://127.0.0.1:8000/images/carrousel/'+footer.imagen"/>
    </div>
...
export default {
    ...
    methods: {
      ...
      enviarMail(){
        ...
        axios.post('http://127.0.0.1:8000/api/enviar_mail', formData)
        .then(function (res) {
            me.$vs.notify({
