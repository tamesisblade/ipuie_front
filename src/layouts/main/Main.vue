    ...
    >
      ...
      <template v-if="mainLayoutType === 'horizontal' && windowWidth >= 1200">
        <the-navbar-horizontal
          ...
          :class="[
            { 'text-red': isNavbarDark && !isThemeDark },
            { 'text-base': !isNavbarDark && isThemeDark }
          ]"
        />

        <div style="height: 82px" v-if="navbarType === 'static'"></div>
...
export default {
  ...
  mounted() {
    /* if (localStorage.tk == null) {
      ...
      if (this.usuario[0].password_status == "0") {
        this.$router.push("/cambio_password");
      }
    } */
  ...
  methods: {
    getMenu() {
      let me = this;
      axios.get("https://server.ipuiecotocollao.com/api/menu?idgrupo="+me.id_perfil)
  ...
  created() {
    ...
    try {
      ...
      if (this.usuario == null || this.usuario.length == 0) {
        ...
        this.id_perfil = this.usuario[0].id_group
      }
