...
<div>
    ...
    <div v-if="usuario[0]" class="the-navbar__user-meta flex items-center">
        ...
        <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
            ...
            <div class="con-img ml-3">
                ...
                <img v-else key="onlineImg" :src="'http://localhost:8000/images/'+usuario[0].foto_user" alt="user-img" width="40" height="40" class="rounded-full shadow-md cursor-pointer block" />
            </div>
    ...
    <div v-else class="the-navbar__user-meta flex items-center">
        ...
        <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
            <div class="con-img ml-3">
                <img key="onlineImg" :src="'http://localhost:8000/images/perfil_usuario.png'" alt="user-img" width="40" height="40" class="rounded-full shadow-md cursor-pointer block" />
            </div>
